  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (
        ...
        !desktopSortRef.current.contains(event.target) &&
    ...
    <div className='mt-4 relative'>
      ...
      <div className='hidden xs:block'>
        ...
        <div className='sm:hidden flex flex-col gap-4'>
          ...
          <div className='flex border border-gray-300 rounded-md px-4 py-2 gap-2 items-center w-full'>
          ...
          <div className='flex justify-between gap-4'>
            ...
            <div className='group flex items-center gap-2 border border-orange-500 rounded-md px-6 py-2 cursor-pointer hover:bg-orange-500 transition-all duration-200'>
            ...
            <div className="relative" ref={mobileSortRef}>
              <div
                ...
                className={`group flex items-center gap-2 border border-orange-500 rounded-md px-6 py-2 cursor-pointer transition-all duration-200
